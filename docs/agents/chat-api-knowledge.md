...
## 🔵 2. Forum Group Discussion Socket.io APIs

### 2.1 Join a Group
*   **Client Event:** `group:join`
*   **Payload:**
```json
{
  "groupId": "66ab00000000000000000000"
}
```
*   Membership is required. Non-members receive `group:error`.

### 2.2 Leave a Group
*   **Client Event:** `group:leave`
*   **Payload:**
```json
{
  "groupId": "66ab00000000000000000000"
...
### 2.3 Send a Group Message
*   **Client Event:** `group:message`
*   **Payload:**
```json
{
  "groupId": "66ab00000000000000000000",
  "content": "I found this helpful too."
}
```
*   **Server Broadcast (`group:message`):**
```json
{
  "_id": "66ac11111111111111111111",
  "groupId": "66ab00000000000000000000",
  "senderId": "66a444444444444444444444",
  "senderRole": "student",
  "senderDisplayName": "Nguyen An",
  "content": "I found this helpful too.",
  "status": "active",
...
### 2.4 Group Typing Indicator
*   **Client Event:** `group:typing`
*   **Payload:**
```json
{
  "groupId": "66ab00000000000000000000",
